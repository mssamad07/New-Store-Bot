...
APP_ID = int(os.environ.get("APP_ID", "28350844")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "d38cfc3c84a96ea8c59383423e3d9faa") #Your API Hash from my.telegram.org
#--------------------------------------------
